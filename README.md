...
> VET CLINIC is a database for keeping records of pets in a vertinary.
...
> Please read through the intructions below to get the application running on your computer.
...
```sh
  ...
  git clone https://github.com/michaelamponsah/vet-clinic.git
